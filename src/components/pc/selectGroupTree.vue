<template>
  <span>
    <custom-dialog
      ...
      class="add-edit"
      ref="addEdit">
      <tree-group ref="tgroups" :selectNode="selectNode" @handleSubmit="handleSubmit"></tree-group>
    </custom-dialog>
  </span>
</template>
...
import CustomDialog from 'components/pc/Dialog'
import TreeGroup from 'components/pc/treeGroup'
